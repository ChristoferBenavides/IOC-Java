        ...
        <div class="jumbotron">
            ...
            <form:form modelAttribute="newXollo" class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-2 col-lg-2" for="matricula">Matricula</label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">                         
                            <form:radiobutton path="hibrid" value="true" />Sí
                            <form:radiobutton path="hibrid" value="false" />No                          
                        </div>
                    </div>
                    <div class="form-group">
