...
public class ControladorMercat implements ActionListener {
    ...
    private void afegirListenersMenu() {
        ...
        for (JButton boto : menuMercat.getMenuButtons()) {
    ...
    private void afegirListenersForm() {
        ...
        mercatForm.getDesar().addActionListener(this);
        mercatForm.getSortir().addActionListener(this);
    ...
    private void afegirListenersLlista() {
        ...
        mercatLlista.getSortir().addActionListener(this);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (mercatForm != null) {
            ...
            if (e.getSource() == mercatForm.getDesar()) {

                if (opcioSelec == 1) {//Alta mercat

                    Mercat mercat = new Mercat(mercatForm.gettNom().getText(), mercatForm.gettAdreca().getText());
                    ControladorPrincipal.getMercats()[ControladorPrincipal.getpMercats()] = mercat;
                    ControladorPrincipal.setpMercats();
                    ControladorPrincipal.setMercatActual(mercat);
                    opcioSelec = 2;

                }

            } else if (e.getSource() == mercatForm.getSortir()) { //Sortir
        ...
        if (mercatLlista != null) {

            if (e.getSource() == mercatLlista.getSortir()) {
    ...
    private void seleccionarOpcio(Integer opcio) {
        ...
        switch (opcio) {
            ...
            case 4: //carregar
                ...
                int code = JOptionPane.showOptionDialog(null, "Selecciona un mètode", "Carregar mercat", 0, JOptionPane.QUESTION_MESSAGE, null, ControladorPrincipal.getMETODESPERSISTENCIA(), "XML");
                ...
                if (code != JOptionPane.CLOSED_OPTION) {
                    ...
                    try {
                        ...
                        gestor.carregarMercat(ControladorPrincipal.getMETODESPERSISTENCIA()[code], codi);

                        if (ControladorPrincipal.getMETODESPERSISTENCIA()[code].equals("XML")) {
                            mercat = ((GestorXML) gestor.getGestor()).getMercat();
                        } else {
                            mercat = ((GestorJDBC) gestor.getGestor()).getMercat();
                        }
            ...
            case 5: //desar
                ...
                if (ControladorPrincipal.getMercatActual() != null) {

                    int tipusMissatge = JOptionPane.QUESTION_MESSAGE;
                    int codi = JOptionPane.showOptionDialog(null, "Selecciona un mètode", "Desar mercat", 0, tipusMissatge, null, ControladorPrincipal.getMETODESPERSISTENCIA(), "XML");
                    ...
                    if (codi != JOptionPane.CLOSED_OPTION) {
                        ...
                        try {
                            gestor.desarMercat(ControladorPrincipal.getMETODESPERSISTENCIA()[codi], String.valueOf(ControladorPrincipal.getMercatActual().getCodi()), ControladorPrincipal.getMercatActual());
                        } catch (GestorMercatsException e) {
                            JOptionPane.showMessageDialog(menuMercat.getFrame(), e.getMessage());
                        }
                    }
                    ...
                    JOptionPane.showMessageDialog(menuMercat.getFrame(), "Abans s'ha de seleccionar un mercat");
                }
