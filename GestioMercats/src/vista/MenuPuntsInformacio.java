 ...
 * @author fta
 */
public class MenuPuntsInformacio {
    ...
    public MenuPuntsInformacio() {
        
        //Definició de la finestra del menú
        frame = new JFrame("Menú Punts d'Informació");
        frame.setLayout(new GridLayout(0, 1));

        //Creació dels botons a la llista
        menuButtons[0] = new JButton("0. Sortir");
        menuButtons[1] = new JButton("1. Alta Punt d'Informació");
        menuButtons[2] = new JButton("2. Llistar Punts d'Informació");
